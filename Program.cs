...
namespace _2019_Fall_Assignment2
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Flip and inverted image:");
            ...
            Console.WriteLine("Min meeting rooms required:"+MinMeetingRooms(intervals));

            //SortedSquares
            int[] input = { -4, -1, 0, 3, 10 };
            int[] o = new int[input.Length];
            o = SortedSquares(input);
            Console.Write("Sorted Squares:");
        ...
        {
            //first create an empty array of the same size as the given input array
            //reverse each row of the multidimensional array by using GetLength method in a nested for-loop
            //Then invert the digits in the multidimensional array
        ...
        {
            //first check each row in the multidimensional array for ascending order,if not, sort them in ascending order
            //next pass the differences of elements in each row into a newly created array
            //finally sorted the array with differences and printed the smallest element
            try
            {
                int[] d = new int[intervals.GetLength(0)];
                for (int i = 0; i < 3; i++)
                {
                    int j = 0, k = 0, t = 0;
        ...
        {
            //take the square of each and every element in the array
            //then sort the array using Array.Sort()
